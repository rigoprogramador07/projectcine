...
<body>
    ...
    <div class="form-group mb-3">
        ...
        <input type="password" class="form-control rounded" id="nueva_contrasena" name="nueva_contrasena" required>
    </div>
    <div class="form-group mb-3">
        <label for="confirmar_contrasena">Confirmar Contraseña:</label>
        <input type="password" class="form-control rounded" id="confirmar_contrasena" name="confirmar_contrasena" required>
    </div>
